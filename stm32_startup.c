...
#define SRAM_SIZE   (192U * 1024U) //192KB
...
/* function prototypes of STM32F42xxx system exception and IRQ handlers */
...
void LCD_ERR_IRQHandler             (void) __attribute__ ((weak, alias("Default_Handler"))); 
